...
void World::build(void) {
    ...
    auto silver = RGBColor{0.95f, 0.93f, 0.88f};
    auto copper = RGBColor{0.95f, 0.64f, 0.54f};
    auto iron = RGBColor{0.56f, 0.57f, 0.58f};
    auto aluminum = RGBColor{0.91f, 0.92f, 0.92f};
